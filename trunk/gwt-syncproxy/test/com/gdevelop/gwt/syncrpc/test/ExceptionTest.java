...
public class ExceptionTest extends TestCase {
	private static ExceptionsTestService service = (ExceptionsTestService) SyncProxy
			.newProxyInstance(ExceptionsTestService.class,
					RPCSyncTestSuite.BASE_URL, "exceptions");
