...
public class StartGAEDevServer {
  ...
  public static void main(String[] args) throws Exception {
    ...
    ServletContainer server = scl.start(new PrintWriterTreeLogger(new AutoFlushPrintWriter(System.out)), 8888, new File("."));
    ...
    while(true){
      ...
      System.out.println("Mem info: Total/Free/Used (in MB): " + total + "/" + free + "/" + (total-free) + ". Mem collected: " + (free-free1) + " MB.");
    }
  }
}
