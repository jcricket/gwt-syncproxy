...
public class CollectionsTest extends TestCase {
	...
	public void testArraysAsList() throws InterruptedException {
	...
	public void testByteArray() throws InterruptedException {
		final CountDownLatch signal = new CountDownLatch(1);
	...
	public void testCharArray() throws InterruptedException {
		final CountDownLatch signal = new CountDownLatch(1);
	...
	public void testFloatArray() throws InterruptedException {
		final CountDownLatch signal = new CountDownLatch(1);
	...
	public void testHashSet() throws InterruptedException {
		final CountDownLatch signal = new CountDownLatch(1);
	...
	public void testIntegerArray() throws InterruptedException {
		final CountDownLatch signal = new CountDownLatch(1);
	...
	public void testLinkedHashMapLRU() throws InterruptedException {
		final CountDownLatch signal = new CountDownLatch(1);
	...
	public void testLongArray() throws InterruptedException {
		final CountDownLatch signal = new CountDownLatch(1);
	...
	public void testPrimitiveBooleanArray() throws InterruptedException {
		final CountDownLatch signal = new CountDownLatch(1);
	...
	public void testPrimitiveByteArray() throws InterruptedException {
		final CountDownLatch signal = new CountDownLatch(1);
	...
	public void testPrimitiveCharArray() throws InterruptedException {
		final CountDownLatch signal = new CountDownLatch(1);
	...
	public void testPrimitiveDoubleArray() throws InterruptedException {
		final CountDownLatch signal = new CountDownLatch(1);
	...
	public void testPrimitiveFloatArray() throws InterruptedException {
		final CountDownLatch signal = new CountDownLatch(1);
	...
	public void testPrimitiveIntegerArray() throws InterruptedException {
		final CountDownLatch signal = new CountDownLatch(1);
	...
	public void testPrimitiveLongArray() throws InterruptedException {
		final CountDownLatch signal = new CountDownLatch(1);
	...
	public void testPrimitiveShortArray() throws InterruptedException {
		final CountDownLatch signal = new CountDownLatch(1);
	...
	public void testShortArray() throws InterruptedException {
		final CountDownLatch signal = new CountDownLatch(1);
	...
	public void testSqlDateArray() throws InterruptedException {
		final CountDownLatch signal = new CountDownLatch(1);
	...
	public void testSqlTimeArray() throws InterruptedException {
		final CountDownLatch signal = new CountDownLatch(1);
	...
	public void testSqlTimestampArray() throws InterruptedException {
		final CountDownLatch signal = new CountDownLatch(1);
	...
	public void testStringArray() throws InterruptedException {
		final CountDownLatch signal = new CountDownLatch(1);
	...
	public void testStringArrayArray() throws InterruptedException {
		final CountDownLatch signal = new CountDownLatch(1);
	...
	public void testTreeMapOptFalse() throws InterruptedException {
		final CountDownLatch signal = new CountDownLatch(1);
	...
	public void testTreeMapOptTrue() throws InterruptedException {
		final CountDownLatch signal = new CountDownLatch(1);
		final TreeMap<String, MarkerTypeTreeMap> expected = TestSetFactory
				.createTreeMap(true);
	...
	public void testTreeSetOptFalse() throws InterruptedException {
		final CountDownLatch signal = new CountDownLatch(1);
	...
	public void testTreeSetOptTrue() throws InterruptedException {
		final CountDownLatch signal = new CountDownLatch(1);
		final TreeSet<MarkerTypeTreeSet> expected = TestSetFactory
				.createTreeSet(true);
		service.echo(expected, true,
